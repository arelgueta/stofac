                  ...
                  <div class="row">
                        <div class="col-xs-4">
                            <div class="form-group">
                                ...
                                <select name="rutas_destino" id="rutas_destino" class="form-control" required>
                                        <option value=""></option> 
...
<!-- START BLOCK : ver_hoja_rutas -->
	   <div class="row">
            <div class="col-md-12">
                <h4 class="sub-header">Hoja Rutas</h4>
                  <div class="table-responsive">
                    <table class="table table-striped">
                      <thead>
                        <tr>
        ...
        <!-- END BLOCK : ver_hoja_rutas -->           
      
<!-- START BLOCK : ver_hoja_cargas -->
	   <div class="row">
            <div class="col-md-12">
                <h4 class="sub-header">Hoja de Carga</h4>
                  <div class="table-responsive">
                    <table class="table table-striped">
                      <thead>
                        <tr>
                      ...
                      <tbody>
                        ...
                        <!-- END BLOCK : fila_rutas2 -->
                      </tbody>
                    </table>
                  </div>   
            </div>                              
        </div>              
        <!-- END BLOCK : ver_hoja_cargas -->            
