...
<div class="container">        
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td style="width:150px;">
                              <a href="index.php?action=comprobantes&imprimir={id_factura}" class="btn btn-sm btn-warning" target="_blank">mostrar</a>
                               
                                <a href="index.php?action=facturas&buscar={id_factura}" class="btn btn-sm btn-warning">Vender</a>
        ...
        <!-- END BLOCK : ver_facturas -->   
                
        <!-- START BLOCK : form_facturas -->
        <div class="row">
                <!-- <hr width="120%">  -->
				<h4>{titulo_form}</h4>
				<h5>Ruta:{id_rutas}</h5>
        ...
        <div class="row">    
            ...
            <div class="col-md-8"> 
                 <form name="form_factura"  id="form_factura" role="form" method="post" action="index.php?action=facturas&{que}={id_factura}">  
                        ...
                        <div class="col-xs-4">
                            <div class="form-group">
                                ...
                                <select name="fac_cliente" id="fac_cliente" class="form-control" onchange="SetCliente();" required>
                                        <!-- START BLOCK : lista_clientes -->
                                        <option value=""></option>
                                                <option value="{id_rutas}*{id_cliente}*{apellido}*{nombre}*{direccion}*{cuit}"{seleccionado_cliente}>{id_cliente}-{apellido}, {nombre}</option>
                                        <!-- END BLOCK : lista_clientes -->
                                        <!-- START BLOCK : lista_clientes2 -->
                                                <option value="{id_cliente}*{apellido}*{nombre}*{direccion}*{cuit}"{seleccionado_cliente} selected> {id_cliente}-{apellido}, {nombre}</option>

                                        <!-- END BLOCK : lista_clientes2 -->
                                </select> 	                        
                            </div>                    
                        </div>
                        <div class="col-xs-3">                
                    ...
                    <div class="row" style="background-color:#f9f9f9;">        
                            <div class="col-xs-5">
                                <div class="form-group">
                                    ...
                                    <label for="fac_producto">Producto</label> 
